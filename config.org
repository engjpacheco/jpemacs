...
- [[#fontsize-and-alpha][FONTSIZE AND ALPHA]]
...
(use-package dashboard
  ...
  (setq dashboard-startup-banner "~/.emacs.d/1.txt")
...
(nvmap :prefix "SPC"
       "<f1>"   '(neotree-toggle :which-key "Toggle neotree file viewer")
...
#+begin_src emacs-lisp
(setq persp-suppress-no-prefix-key-warning t) ;;emacs28 rare things
;(column-number-mode)
