#+TITLE: JP Emacs Config
#+AUTHOR: Javier Pacheco
#+DESCRIPTION: Javier Pacheco personal Emacs config.
#+STARTUP: showeverything
#+EXPORT_FILE_NAME: ~/org/html/config.html
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+OPTIONS: num:nil ^:{} toc:nil
#+PROPERTY: headers-args :tangle config.el
#+auto_tangle: t
...
(setq org-directory "~/.emacs.d/org/"
      ;; org-agenda-files '("~/.emacs.d/org/*.org" "~/.emacs.d/org/amm/*.org")
      org-ellipsis " ▼ "
      org-log-done 'time
...
(global-set-key (kbd "C-c o") 
                (lambda () (interactive) (find-file "~/.emacs.d/org/amm.org")))
(global-set-key (kbd "C-c c") 'org-capture)

;; Config Files for OrgMode
(load "~/.emacs.d/org/config/org-capture.el") ;;custom org-capture
(load "~/.emacs.d/org/config/org-agenda.el")  ;;custom org-agena
(load "~/.emacs.d/org/config/doom-dashboard.el")
#+end_src

** Enabling Org Bullets
Org-bullets gives us attractive bullets rather tan asterisks.
...
(nvmap :prefix "SPC"
       ...
       "k b"   '(kill-current-buffer :which-key "Kill current buffer")
...
(dashboard-startup-banner "~/.emacs.d/pac.txt")
...
(nvmap :prefix "SPC"
       "o o"   '(neotree-toggle :which-key "Toggle neotree file viewer")
...
(nvmap :prefix "SPC"
       ;; Window splits
       "c w"   '(evil-window-delete :which-key "Close window")
       "n w"   '(evil-window-new :which-key "New window")
       "s w"   '(evil-window-split :which-key "Horizontal split window")
       "v v"   '(evil-window-vsplit :which-key "Vertical split window")
       ;; Window motions
...
* Personal configs.
here I'll add some more extra stuff to this config.
** Some warnings
#+begin_src emacs-lisp
;;emacs28 rare things
